...
bool battle() {
    ...
    int playerInput;
    /*
    Due to changes in how I defined the vectors, the bool
    battle has been moved down in the new code because I had to
    initialize the compound object Attack first
    */
    cout << endl;
    ...
    while (playerHealth > 0 && monsterHealth > 0) {
        ...
        if(playerInput == 1){       //This is the BasicAttack
            int min = 15;
            int max = 25;
        ...
        else if (playerInput == 2){         //Lightning Strike
            int damageSum = 0;
