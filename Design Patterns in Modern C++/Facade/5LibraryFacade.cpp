...
// Display function for books ++ STYLE EDITS USING SETWIDTH
...
I believe that in theory, a facade functions similarly to when we create functions that we
put in header&source files, such that the main.cpp would be easier to navigate for clients
