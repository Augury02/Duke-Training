...
/*
This is the final product of my attempt to combine both the locator and sorting features from last week
Adapters allowed me to clear out a lot of redundancies with regards to defining the books
because the previous combination used 2 different databases for each feature
*/
using namespace std;
