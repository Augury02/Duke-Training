...
bool battle() {
    ...
    int monsterHealth = 500;            //only one monsterHealth value is declared
    int playerInput;
    int enhanceInput;
    ...
    vector<shared_ptr<Attack>> monsterAttacks = {       //There are only 3 available attacks since only
                                                        //one monster object will be created
    ...
    cout << endl;
    cout << "A wild monster appears!" << endl;          //There wasn't enemy variety prior to proxy implementation
